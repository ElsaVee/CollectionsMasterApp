    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            //Console.WriteLine (numArray.Reverse());
            ...
            Console.WriteLine($"List of 50:");
            Populater(numbers);

            //TODO: Print the new capacity
            Console.WriteLine ($"New Capacity:{ numbers.Count}");
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes, we have {searchNumber} in stock!");
            }
            else
            {
                Console.WriteLine($"Yes, we have no {searchNumber}s today...");
            }
        }
